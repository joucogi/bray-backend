...
namespace Bray\Shared\Infrastructure\Doctrine;

use Bray\Shared\Infrastructure\Doctrine\Dbal\DbalCustomTypesRegister;
...
final class DoctrineEntityManagerFactory
{
    private static array $sharedPrefixes = [
        __DIR__ . '/../../../Shared/Infrastructure/Persistence/Mappings' => 'Bray\Shared\Domain',
    ];
